...
PYTHON=python
COVERAGE=coverage
NOSE_OPTS = --with-xunit --xunit-file=report/nosetests.xml --with-coverage --cover-package=$(NAME) --cover-html
#NOSE_OPTS = --with-xunit --xunit-file=report/nosetests.xml --with-coverage --cover-package=$(NAME)
